...
export default function BrandStory(){
    return<>
        <div className='brandStory'>
            <div>
                <span class="brandStory-title">
                    Brand Story
                </span>
                <br />
                <span className='brandStory-content'>
                모바일에 최적화된 비디오를 단 몇 분 만에 제작해보세요. 디자이너가 아니더라도,  모든 팀에서<br />
                다듬을 수 있습니다. 브랜드의 성공을 위한 첫 걸음을  내딛어보세요. 비디오를 단 몇 분 만에 제작해보세요.
                </span>
            </div>
            
            <div className='brandStory-what'>
                <span class="brandStory-WhatHappeneds">
                    What Happened’s Brand story
                </span>
                <br />
                <p class="brandStory-WhatHappeneds-content">
                ...
                <br />
                <a className='a-content' href="#">SEE MORE</a>
            </div>
        </div>
